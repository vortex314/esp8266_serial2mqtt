...
USER_DEFINE = -DWIFI_SSID=\"Merckx3\" -DWIFI_PSWD=\"LievenMarletteEwoutRonald\" \
	-Ilibraries/Common/src -I../pubsubclient/src -Ilibraries/Ebos -DMQTT_MAX_PACKET_SIZE=768 -DMQTT_MAX_TRANSFER_SIZE=900 -DESP8266
USER_LINK =  -lmain  
OTA_IP = 192.168.1.184
OTA_PORT = 8266 
OTA_AUTH = password
USER_LIBS= pubsubsclient Common Ebos DWM1000
USRCDIRS =  src Common/src Ebos DWM1000
